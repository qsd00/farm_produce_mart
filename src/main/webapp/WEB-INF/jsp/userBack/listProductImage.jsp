                ...
                <div>
                    <div class="panel panel-warning addPictureDiv">
                        ...
                        <div class="panel-body">
                            <form method="post" class="addFormSingle" action="userBack_productImage_add" enctype="multipart/form-data">
                    ...
                    <table class="table table-striped table-bordered table-hover  table-condensed">
                        ...
                        <tbody>
                        <c:forEach items="${pisSingle}" var="pi" varStatus="status">
                            <tr>
                                <td>${status.count}</td>
                                <td>
                                ...
                                <td><a deleteLink="true"
                                       href="userBack_productImage_delete?id=${pi.id}"><span
            ...
            <td class="addPictureTableTD">
                <div>
                    ...
                    <div class="panel panel-warning addPictureDiv">
                        ...
                        <div class="panel-body">
                            <form method="post" class="addFormDetail" action="userBack_productImage_add" enctype="multipart/form-data">
                                <table class="addTable">
                                    <tr>
                    ...
                    <table class="table table-striped table-bordered table-hover  table-condensed">
                        ...
                        <tbody>
                        <c:forEach items="${pisDetail}" var="pi" varStatus="status">
                            <tr>
                                <td>${status.count}</td>
                                <td>
